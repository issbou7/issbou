                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <label for="devicesLimitInput"><input type="checkbox" id="toggleDevicesLimitInput"
                                                                      onchange="disableInput('#toggleDevicesLimitInput', '#devicesLimitInput')">&nbsp;<?= __("max_devices"); ?>
                                </label>
                                <div class="input-group">
                                    <div class="input-group-addon">
                                        <i class="fa fa-android"></i>
                                    </div>
                                    <input type="number" name="devicesLimit" class="form-control" min="1"
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" name="contactsLimit" class="form-control" min="1"
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label for="devicesLimitEditInput"><input type="checkbox"
                                                                          ...
                                                                          onchange="disableInput('#toggleDevicesLimitEditInput', '#devicesLimitEditInput')">&nbsp;<?= __("max_devices"); ?>
                                </label>
                                <div class="input-group">
                                    <div class="input-group-addon">
                                        <i class="fa fa-android"></i>
                                    ...
                                    <input type="number" name="devicesLimit" class="form-control"
                                           id="devicesLimitEditInput" min="1" required="required" disabled>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" name="contactsLimit" class="form-control"
                                           id="contactsLimitEditInput" min="1" required="required" disabled>
                                </div>
                            </div>
                            <div class="form-group">
