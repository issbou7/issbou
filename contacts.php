            ...
            <div class="col-xs-12">
                ...
                <?php if ($totalContactsLists > 0) { ?>
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <div class="pull-left">
                                <select title="Contacts List" class="form-control select2" id="contacts-list">
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    <label for="devicesInput"><?= __("device"); ?>
                                        <a href="#send-message" id="selectAllDevices">
                                            <i class="fa fa-plus-square"></i>
                                        </a>
                                        <a href="#send-message" id="clearAllDevices">
            ...
            const dropZone = new Dropzone(".dropzone", {
                ...
                init: function () {
                    ...
                    this.on("success", function (data, response) {
                        ...
                        const options = {positionClass: "toast-top-center", closeButton: true};
                        if (obj.error) {
                            toastr.error(obj.error, null, options);
                        } else {
                            toastr.success(obj.result, null, options);
                            reloadContacts();
                        }
                    });
                }
