    ...
    <section class="content">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <!-- /.box-header -->
                <!-- form start -->
                <form role="form" id="sendMessage" action="ajax/send-message.php" method="post" enctype="multipart/form-data">
                    <div class="box-body">
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                <label for="devicesInput"><?= __("devices"); ?>
                                    <a href="#sendMessages" id="selectAllDevices">
                                        <i class="fa fa-plus-square"></i>
                                    </a>
                                    <a href="#sendMessages" id="clearAllDevices">
