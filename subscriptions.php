                                    ...
                                    <div class="input-group">
                                        ...
                                        <select name="userID" class="form-control select2" id="userIDInput"
                                            ...
                                            foreach ($users as $user) {
                                                createOption("{$user->getName()} ({$user->getEmail()})", $user->getID(), false);
                                            }
                                            ?>
                                        </select>
                                    </div>
...
<script type="text/javascript">
    $(function () {
        ...
        function initSubscriptions() {
            $("#subscriptions").on("click", ".cancel-subscription", function (event) {
        ...
        function initPayments() {
            $("#payments").on("click", ".refund-payment", function (event) {
                event.preventDefault();
