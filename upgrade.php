...
try {
    ...
    queryDb("ALTER TABLE User MODIFY delay varchar(7) NOT NULL DEFAULT '0'");
    try {
  ...
  `arguments` text NOT NULL
    ...
    queryDb("CREATE TABLE IF NOT EXISTS Contact (ID int(11) AUTO_INCREMENT PRIMARY KEY,name varchar(255) DEFAULT NULL,number varchar(255) NOT NULL,subscribed tinyint(1) NOT NULL DEFAULT '1',token varchar(255) NOT NULL,contactsListID int(11) NOT NULL,UNIQUE KEY `token` (`token`),FOREIGN KEY (contactsListID) REFERENCES ContactsList(ID) ON DELETE CASCADE)ENGINE=InnoDB;");
