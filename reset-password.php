        ...
        if (count($users) <= 0) {
            ...
            if ($timestamp && ctype_digit($timestamp)) {
                ...
                if ($diff > 86400) {
                    ...
                    $body = __("reset_password_email_body", ["app" => __("application_title"), "user" => $user->getName(), "userEmail" => $user->getEmail(), "admin" => $admin->getName(), "adminEmail" => $admin->getEmail(), "password" => $random_password, "server" => $serverURL]);
                    try {
